...
export default function CoursesPage() {
  ...
  const [subscribedFilter, setSubscribedFilter] = useState<boolean | null>(
    null,
  );
  ...
  const filteredCourses = useMemo(() => {
    return courses
      .filter((course) => {
        ...
        const matchesTerm =
          termFilter === null || course.term?.name === termFilter;
        const matchesSubscribed =
          subscribedFilter === null || course.subscribed === subscribedFilter;
  ...
  const isIndeterminate =
    selectedCourses.size > 0 && selectedCourses.size < filteredCourses.length;
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground text-pretty">
                Manage your Canvas course subscriptions
              </p>
            </div>
